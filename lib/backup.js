...
// expires daily anyway, so neither is included. encryptedPassword is also
// excluded: it's safeStorage-encrypted to this Windows account/machine (see
...
function buildBackupPayload() {
  return {
    ...
    accounts: getAccounts().map(({ cache, encryptedPassword, ...rest }) => rest),
  };
}
