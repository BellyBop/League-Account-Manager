...
function getSettings() {
  return readJson(settingsPath(), {
    ...
    zoomLevel: 0,
    // Shared by local and cloud backups alike — see lib/backup.js.
    backupPassphraseEncrypted: null,
    backupVerifier: null,
    localBackupIncludePasswords: false,
    // Empty means "use the built-in auto-backups folder" (autoBackupDir() in
    // this same file) — set once someone picks somewhere else, mirroring
    // cloudBackupFolder below.
    localBackupFolder: '',
    cloudBackupEnabled: false,
    cloudBackupFolder: '',
    cloudBackupIncludePasswords: false,
